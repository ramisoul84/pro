...
const fe_data = [
  ...
  { id: 3, icon: <IoLogoJavascript />, name: "Java Script", rate: 60 },
  { id: 4, icon: <DiJqueryLogo />, name: "JQuery", rate: 50 },
  { id: 5, icon: <RiReactjsFill />, name: "React", rate: 70 },
];
const be_data = [
  { id: 1, icon: <SiPhp />, name: "PHP", rate: 80 },
  { id: 2, icon: <SiMysql />, name: "MySQL", rate: 60 },
  { id: 3, icon: <SiCplusplus />, name: "C++", rate: 60 },
];
const ai_data = [
